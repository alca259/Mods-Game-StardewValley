...
internal class ShowItemEffectRanges : IDisposable
{
    ...
    private static List<Object> GetSimilarObjectsInLocation(string nameContains)
    {
    ...
    private static int[][] GetDistanceArray(ObjectsWithDistance type, bool hasPressureNozzle = false, Object? instance = null)
    {
        switch (type)
        {
