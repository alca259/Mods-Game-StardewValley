...
internal class ModOptionsPageHandler : IDisposable
{
    ...
    /// </summary>
    private static void AddOurTabToClickableComponents(GameMenu gameMenu, ClickableComponent modOptionsTab)
    {
    ...
    private static int GetButtonXPosition(GameMenu gameMenu)
    {
